    ...
    class CommandeDAO : DAO<Commande>
    {
       ...
       public int add(Commande e)
        ...
        public int delete(int id)
        {
            ...
            try
            {
                SqlCommand sqlCmd1 = new SqlCommand("SELECT NumTable FROM Commande WHERE IdCommande=@id",cnx);
                ...
                SqlCommand UpdateTable = new SqlCommand("UPDATE Tables SET Etat=@nb where NumTable=@Numtable", cnx);
                UpdateTable.Parameters.AddWithValue("Numtable",numtable);
                UpdateTable.Parameters.AddWithValue("nb", 0);
        ...
        public List<Article> listArticle(int id)
        {
            ...
            {
                SqlConnection cnx = Connexion.GetConnection();
                SqlCommand cmd2 = new SqlCommand("SELECT numArticle,qte FROM lignecmd WHERE numcmd=@id", cnx);
